...
int main(int args, char** argv){
  ...
  cout << "addition opertion on float values is " << float1 + float2 << endl << endl;
  
  // subtraction operation
  cout << "subtraction opertion on integer values is " << int1 - int2 << endl;
  cout << "subtraction opertion on float values is " << float1 - float2 << endl << endl;

  // division operation
  cout << "division opertion on integer values is " << int1 / int2 << endl;
  cout << "division opertion on float values is " << float1 / float2 << endl << endl;
  
  // multiplication operation
  cout << "multiplication opertion on integer values is " << int1 * int2 << endl;
  cout << "multiplication opertion on float values is " << float1 * float2 << endl << endl;
 
  // modulos operation
  cout << "modulos opertion on integer values is " << int1 % int2 << endl << endl ;
  
  // compound modulos operation
  {
    int value = int1;
    value %= int2;
    cout << "compound modulos opertion on integer values is " << value<< endl << endl;
  ...
  // power operator
  {
    ...
    cout << "power opertion on float values is " << pow(float1, float2) << endl << endl;
  }
